...
const create_relationship_validation_string_1 = require("./create-relationship-validation-string");
...
function createUpdateAndParams({ updateInput, varName, node, parentVar, chainStr, withVars, context, callbackBucket, parameterPrefix, includeRelationshipValidation, }) {
    ...
    const conflictingProperties = (0, find_conflicting_properties_1.findConflictingProperties)({ node, input: updateInput });
                ...
                updates.forEach((update, index) => {
                    ...
                    if (update.create) {
                        ...
                        creates.forEach((create, i) => {
                            ...
                            const relationshipValidationStr = (0, create_relationship_validation_string_1.createRelationshipValidationString)({
                                node: refNode,
                                context,
                                varName: nodeName,
                            });
    ...
    const relationshipValidationStr = includeRelationshipValidation
        ? (0, create_relationship_validation_string_1.createRelationshipValidationString)({ node, context, varName })
        : "";
