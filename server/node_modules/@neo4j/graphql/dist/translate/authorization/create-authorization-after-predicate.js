...
exports.createAuthorizationAfterPredicateField = exports.createAuthorizationAfterPredicate = void 0;
...
function createAuthorizationAfterPredicate({ context, nodes, operations, }) {
    ...
    for (const nodeEntry of nodes) {
        ...
        const nodeSubqueries = (0, utils_2.filterTruthy)((0, utils_1.asArray)(nodeRawSubqueries)).map((sq) => (0, wrap_subquery_in_call_1.wrapSubqueryInCall)(sq, matchNode));
