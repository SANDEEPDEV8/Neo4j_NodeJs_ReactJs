...
function withSourceWhereInputType({ relationshipAdapter, composer, deprecatedDirectives, userDefinedDirectivesOnTargetFields, features, }) {
    ...
    const fields = (0, augment_where_input_1.augmentWhereInputTypeWithRelationshipFields)(relationshipAdapter, deprecatedDirectives, features);
    whereInput.addFields(fields);
    const connectionFields = (0, augment_where_input_1.augmentWhereInputTypeWithConnectionFields)(relationshipAdapter, deprecatedDirectives, features);
