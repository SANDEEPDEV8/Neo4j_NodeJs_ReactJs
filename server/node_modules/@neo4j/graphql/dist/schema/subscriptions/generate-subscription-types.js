...
function generateSubscriptionTypes({ schemaComposer, schemaModel, userDefinedFieldDirectivesForNode, generateRelationshipTypes, features, }) {
    ...
    nodesWithSubscriptionOperation.forEach((entityAdapter) => {
        ...
        const relationshipCreatedEvent = createField("create_relationship");
        const relationshipDeletedEvent = createField("delete_relationship");
...
function getRelationshipField({ entityAdapter, relationshipName, nodeToRelationFieldMap, }) {
